component {
	...
	public any function init(required string xml, required struct config) {
	...
	private any function getBeanInstance(required string beanName) {
		...
		lock name="coldmvc.utils.SimpleBeanFactory.getBeanInstance.#beanName#" type="exclusive" timeout="5" throwontimeout="true" {
